...
echo !ESC![32mScanning directories for compile.bat files...!ESC![0m
...
echo !ESC![35mLaunching !INDEX! builds in parallel...!ESC![0m
...
echo !ESC![97mWaiting for background builds to complete...!ESC![0m
...
echo.
echo !ESC![92mAll compile.bat scripts completed!!ESC![0m
